...
def generate_launch_description():
    ...
    coke_world = join(get_package_share_directory("maciv4"), "models","cokeworld.sdf")
    ...
    robot_file = join(get_package_share_directory("maciv4"), "robot_description","maciv4.urdf.xacro")
    ...
    move_group = IncludeLaunchDescription(join(get_package_share_directory("maciv4_moveit"), "launch", "move_group.launch.py"))
    rviz = IncludeLaunchDescription(join(get_package_share_directory("maciv4_moveit"), "launch", "moveit_rviz.launch.py"))
